...
//mover carro
float posX_carro = -170;		//Variable para PosicionX
float posY_carro = -22;		//Variable para PosicionY
float posZ_carro = -214;		//Variable para PosicionZ
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		////Pierna Der
		view = camera.GetViewMatrix();
		model = glm::translate(tmp, glm::vec3(0, 0, 0));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
